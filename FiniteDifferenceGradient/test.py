...
def my_finite_diff_grad(params):
    ...
    print(type(params))
    print(params.item(0))
    print(cost(params.item(0)))
    for i in range(len(params)):
        # QHACK # 
            gradients[i].append=i
            #(cost(params.item(i)+params.item(i)/2)-cost(params.item(i)-params.item(i)/2))/params.item(i)
        # QHACK #
...
def cost(params):
    ...
    print("Type of variational_circuit(params) is: ", type(variational_circuit(params)))
